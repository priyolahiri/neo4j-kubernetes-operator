...
> **⚠️ Upgrading from v1.6.0-alpha or earlier requires manifest changes.** See the [Migration Guide](docs/user_guide/migration_guide.md#upgrading-to-v160-alpha-api-stabilization) for details.
