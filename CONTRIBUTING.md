...
# Install all pinned versions (Go 1.27, Kind 0.27.0, kubectl 1.36.0, etc.)
mise install
```
...
- **Issues**: [GitHub Issues](https://github.com/priyolahiri/neo4j-kubernetes-operator/issues) — best-effort support; no official or commercial support.
- **Discussions**: [GitHub Discussions](https://github.com/priyolahiri/neo4j-kubernetes-operator/discussions)

## License

By contributing, you agree that your contributions will be licensed under the **Apache License 2.0**, the license of this project.
