...
The recommended path is the Helm chart repository:
...
The chart is also published to the OCI registry:
...
2.  **Deploy the cluster:**
    ...
    kubectl apply -f https://raw.githubusercontent.com/priyolahiri/neo4j-kubernetes-operator/main/examples/clusters/multi-server-cluster.yaml

    # Three-server cluster, no TLS (simplest for local testing)
    kubectl apply -f https://raw.githubusercontent.com/priyolahiri/neo4j-kubernetes-operator/main/examples/clusters/three-node-simple.yaml
    ```
...
Ready-to-apply YAML manifests for every CRD live under [`examples/`](https://github.com/priyolahiri/neo4j-kubernetes-operator/tree/main/examples):

| Directory | What's in it |
|---|---|
| [`standalone/`](https://github.com/priyolahiri/neo4j-kubernetes-operator/tree/main/examples/standalone) | Single-node `Neo4jEnterpriseStandalone` examples |
| [`clusters/`](https://github.com/priyolahiri/neo4j-kubernetes-operator/tree/main/examples/clusters) | `Neo4jEnterpriseCluster` topologies (minimal, prod, TLS, fleet-managed) |
| [`databases/`](https://github.com/priyolahiri/neo4j-kubernetes-operator/tree/main/examples/databases) | `Neo4jDatabase` examples (basic, seed URI, custom topology) |
| [`users-roles/`](https://github.com/priyolahiri/neo4j-kubernetes-operator/tree/main/examples/users-roles) | `Neo4jUser`, `Neo4jRole`, `Neo4jRoleBinding`, `Neo4jAuthRule` |
