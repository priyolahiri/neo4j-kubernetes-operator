...
*   `spec.propertySharding`: (Neo4j 2025.06+) Enable property sharding for horizontal scaling of large datasets. See the [Property Sharding Guide](property_sharding.md) for detailed configuration options.
