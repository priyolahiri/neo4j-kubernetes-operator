...
See [`examples/clusters/storage-expansion.yaml`](https://github.com/neo4j-partners/neo4j-kubernetes-operator/blob/main/examples/clusters/storage-expansion.yaml) for a complete example.
