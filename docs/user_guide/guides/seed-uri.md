...
See the [examples/databases/](https://github.com/neo4j-partners/neo4j-kubernetes-operator/tree/main/examples/databases) directory for comprehensive examples:
